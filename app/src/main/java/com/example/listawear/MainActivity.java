...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new ItemsList(R.mipmap.basket, "Basquetbol", "Basquetbol"));
        items.add(new ItemsList(R.mipmap.fot, "Futbol ", "Futbol "));
        items.add(new ItemsList(R.mipmap.natacion, "Natacion", "Natacion"));
        items.add(new ItemsList(R.mipmap.voli, "Voleibol", "Voleibol"));
